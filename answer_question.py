#!/usr/bin/env python3
"""
Question Answering System using DeepSeek LLM and MongoDB
"""
...
class QuestionAnsweringSystem:
    ...
    async def search_relevant_chunks(self, question: str, limit: int = 50) -> List[Dict[str, Any]]:
...
async def main():
    """Main function to test the question answering system"""
