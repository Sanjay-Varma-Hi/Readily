#!/usr/bin/env python3
"""
Comprehensive Question Answering System with External Source Integration
Searches internal documents first, then automatically searches external sources if answer is UNKNOWN
"""
...
3. All Plan Letters (APLs) related to hospice services
...
async def main():
    ...
    questions = [
        ...
        "Does the P&P state that under existing Contract requirements and state law, MCPs are required to provide hospice services upon Member election to start and receive such care services?",
        "What are the benefit periods for hospice coverage according to the P&P?"
    ]
