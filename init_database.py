#!/usr/bin/env python3
"""
Database initialization script for READILY
...
async def init_database():
    ...
    try:
        ...
        await db.embeddings.create_indexes([
        ...
        await db.questionnaires.create_indexes([
            IndexModel([("uploaded_at", DESCENDING)]),
            IndexModel([("status", ASCENDING)])
        ])
        ...
        await db.policy_folders.create_indexes([
